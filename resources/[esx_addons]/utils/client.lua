...
function SetData()
	...
	Citizen.InvokeNative(GetHashKey("ADD_TEXT_ENTRY"), 'FE_THDR_GTAO', '~r~New World~s~ | ID : ~p~'.. id ..'~w~ | Joueurs connectés : ~p~' .. #players .."~w~/48 " )
end
...
Citizen.CreateThread(function()
    AddTextEntry("PM_PANE_LEAVE", "~r~Se déconnecter ~w~de~r~ New World")
end)
