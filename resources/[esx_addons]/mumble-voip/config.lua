...
mumbleConfig = {
    ...
    voiceModes = {
        ...
        {8.0, "Parler"}, -- Normal speech distance in gta distance units
    ...
    radioSpeakerEnabled = false, -- Allow players to hear all talking participants in a radio if standing next to someone that has a radio
